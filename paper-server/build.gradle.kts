...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "UlyxSpigot",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "UlyxSpigot",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "UlyxSpigot Team",
            "Brand-Id" to "ulyxspigot:ulyxspigot",
            "Brand-Name" to "UlyxSpigot",
